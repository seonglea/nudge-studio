...
export const metadata: Metadata = {
  title: "My Cafe — Nudge Studio",
  description: "Your home café, beautifully managed.",
};
          ...
          <div className="flex flex-col sm:flex-row gap-10 sm:items-start">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span
                  className="text-[11px] px-3 py-1 rounded-full border border-[#2a1f10] text-[#888888]"
                  style={{ fontFamily: "var(--font-jetbrains-mono)" }}
                >
                  iOS · Android
                </span>
              ...
              >
                Your home café, beautifully managed.
              </p>

              <p
                className="text-base leading-relaxed max-w-xl"
                style={{ color: "#b89a78", fontFamily: "var(--font-dm-sans)" }}
              >
                For people who brew at home instead of buying out. Track your
                beans, milk, and syrups in the Fridge; save your recipes in
                Notes; see today&apos;s savings on a receipt; and display your
                menu on a chalk Board. My Cafe knows what you can make right
                now — and adds what you&apos;re out of to your shopping list.
              </p>
            </div>
          </div>
        </section>
