...
export const metadata: Metadata = {
  title: "Before: Record Ahead — Nudge Studio",
  description: "Record it before it matters.",
};
          ...
          <div className="flex flex-col sm:flex-row gap-10 sm:items-start">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span
                  className="text-[11px] px-3 py-1 rounded-full border border-[#1a2e1a] text-[#888888]"
                  style={{ fontFamily: "var(--font-jetbrains-mono)" }}
                >
                  iOS · Android
                </span>
              ...
              >
                Record it before it matters.
              </p>

              <p
                className="text-base leading-relaxed max-w-xl"
                style={{ color: "#7aaa8a", fontFamily: "var(--font-dm-sans)" }}
              >
                Before helps you capture and organize important records before
                it matters — photos, notes, documents, and optional private
                email alerts, all in one place. Because the best time to
                document something is before you need it.
              </p>
            </div>
          </div>
        </section>
